...
if ( ! function_exists( 'recpl_fs' ) ) {
	...
	recpl_fs()->add_filter( 'pricing/show_annual_in_monthly', '__return_false' );
	...
	recpl_fs()->add_filter(
		...
		function () {
			...
			return __DIR__ . '/assets/images/rp-icon.png';
		}
	);
	...
	recpl_fs()->add_action( 'after_uninstall', 'recpl_fs_uninstall_cleanup' );
 ...
 */
function recpl_fs_uninstall_cleanup() {
