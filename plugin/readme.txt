...
= 1.2.40 - 2026-03-27 =
* Fix: Privacy consent validation now works correctly in standard form
* Fix: Time display improved - shows "Just now", "Today at HH:MM", "Yesterday" instead of wrong "1 Tage her"
* Fix: German translations corrected for singular/plural time strings (Tag/Tage, Stunde/Stunden)
* Fix: Nonce verification accepts both generic and ID-specific nonces for status changes
...
* Fix: admin.js marked as premium-only (React UI only in Pro)
* Fix: Regex pattern in slug field corrected for browser compatibility
