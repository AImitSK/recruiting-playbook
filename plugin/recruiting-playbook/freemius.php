...
function rp_fs_uninstall_cleanup() {
    ...
    if ( is_dir( $rp_upload_dir ) ) {
        // Rekursiv löschen.
        $files = new \RecursiveIteratorIterator(new \RecursiveDirectoryIterator($rp_upload_dir, \RecursiveDirectoryIterator::SKIP_DOTS), \RecursiveIteratorIterator::CHILD_FIRST);
