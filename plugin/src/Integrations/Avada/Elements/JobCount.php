		...
		return [
			...
			'params' => [
				...
				[
					...
					'description' => esc_attr__( 'Text für mehrere Stellen. Verwende {count} als Platzhalter.', 'recruiting-playbook' ),
					'param_name'  => 'format',
				...
				[
					...
					'description' => esc_attr__( 'Text für eine Stelle. Verwende {count} als Platzhalter.', 'recruiting-playbook' ),
					'param_name'  => 'singular',
				...
				[
					...
					'description' => esc_attr__( 'Text wenn keine Stellen vorhanden sind.', 'recruiting-playbook' ),
					'param_name'  => 'zero',
