...
class Shortcodes {
	...
	public function renderJobList( $atts ): string {
		...
		// Cache-Priming wie im Archive-Template.
		...
		<div class="rp-plugin">
			<div class="<?php echo esc_attr( $grid_classes ); ?>">
				...
				while ( $query->have_posts() ) :
					...
					// Job-Card Partial einbinden (identisch mit archive-job_listing.php).
	...
	public function renderJobSearch( $atts ): string {
		...
		// Job-Liste Settings.
		$job_list_layout          = $design_settings['job_list_layout'] ?? 'grid';
		$design_show_badges       = $design_settings['show_badges'] ?? true;
		$design_show_location     = $design_settings['show_location'] ?? true;
		$design_show_employment   = $design_settings['show_employment_type'] ?? true;
		$design_show_salary       = $design_settings['show_salary'] ?? true;
		$design_show_deadline     = $design_settings['show_deadline'] ?? false;
